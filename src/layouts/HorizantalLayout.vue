<template>
  <div>
    ...
    <div class="wrapper">
      ...
      <DefaultNavBar
        title="Dashboard"
        v-if="$route.name === 'dashboard.home-2'"
        ...
        <template slot="responsiveRight">
          <ul class="navbar-nav ml-auto navbar-list">
            ...
            <li class="nav-item">
              <a href="#" class="search-toggle iq-waves-effect">
                <lottie
                  :option="require('../assets/images/small/lottie-mail')"
                  id="lottie-mail"
                />
      ...
      <MenuNavBar
        title="Dashboard"
        v-if="$route.name === 'dashboard.home-3'"
        :homeURL="{ name: 'dashboard.home-1' }"
        :sidebarGroupTitle="sidebarGroupTitle"
        @toggle="sidebarMini"
        :logo="logo"
...
import HorizontalItems from '../StaticData/json/HorizontalMenu'
